...
const xrlVersion = [2, 3000, 1035194821];
...
const fetchLatestxrlVersion = async (options = {}) => {
  const URL = 'https://raw.githubusercontent.com/WhiskeySockets/xrl/master/src/Defaults/index.ts';
  try {
    ...
    if (!response.ok) {
      throw new _boom.Boom(`Failed to fetch latest xrl version: ${response.statusText}`, {
 ...
 * Use to ensure your WA connection is always on the latest version
 */
exports.fetchLatestxrlVersion = fetchLatestxrlVersion;
exports.fetchLatestBaileysVersion = fetchLatestxrlVersion;
