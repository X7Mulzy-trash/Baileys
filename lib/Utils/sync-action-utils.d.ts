...
import type { xrlEventEmitter, xrlEventMap, Contact } from '../Types/index.js';
...
export type LidMappingUpdateResult = {
    ...
    data: xrlEventMap['lid-mapping.update'];
};
...
export declare const emitSyncActionResults: (ev: xrlEventEmitter, results: SyncActionResult[]) => void;
