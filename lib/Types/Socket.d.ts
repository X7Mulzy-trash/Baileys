...
export type SocketConfig = {
    ...
    /** should xrl use the mobile api instead of the multi device api
    ...
    /** Should xrl ask the phone for full history, will be received async */
    syncFullHistory: boolean;
    /** Should xrl fire init queries automatically, default true */
