...
export type xrlEvent = keyof xrlEventMap;
export interface xrlEventEmitter {
    on<T extends keyof xrlEventMap>(event: T, listener: (arg: xrlEventMap[T]) => void): void;
    off<T extends keyof xrlEventMap>(event: T, listener: (arg: xrlEventMap[T]) => void): void;
    removeAllListeners<T extends keyof xrlEventMap>(event: T): void;
    emit<T extends keyof xrlEventMap>(event: T, arg: xrlEventMap[T]): boolean;
}
